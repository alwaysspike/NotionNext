...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'See you, spacecowboy',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '青丘', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '用理性对抗狂热，用包容对抗狭隘', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.spacecowboyspike.space', // 网站地址
